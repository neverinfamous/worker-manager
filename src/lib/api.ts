...
export async function getWorker(
  name: string,
  options?: FetchOptions,
): Promise<ApiResponse<WorkerDetails>> {
  return apiFetch<WorkerDetails>(
    `/workers/${encodeURIComponent(name)}`,
    {},
    options,
  );
}
...
export async function getWorkerRoutes(
  ...
  return apiFetch<WorkerRoute[]>(
    `/workers/${encodeURIComponent(name)}/routes`,
    {},
    options,
  );
}
...
export async function createWorkerRoute(
  ...
  return apiFetch<WorkerRoute>(
    `/workers/${encodeURIComponent(workerName)}/routes`,
    {
      method: "POST",
...
export async function deleteWorkerRoute(
  ...
  return apiFetch<null>(
    `/workers/${encodeURIComponent(workerName)}/routes/${encodeURIComponent(routeId)}?zone_id=${encodeURIComponent(zoneId)}`,
    {
      method: "DELETE",
    },
  );
 ...
 */
export async function getWorkerSecrets(
  name: string,
  options?: FetchOptions,
): Promise<ApiResponse<WorkerSecret[]>> {
  return apiFetch<WorkerSecret[]>(
    `/workers/${encodeURIComponent(name)}/secrets`,
    {},
    options,
  );
}
...
export async function deleteWorkerSecret(
  ...
  invalidateCache(`/workers/${workerName}/secrets`);
  return apiFetch<null>(
    `/workers/${encodeURIComponent(workerName)}/secrets/${encodeURIComponent(secretName)}`,
    {
      method: "DELETE",
    },
  );
...
export async function getWorkerSettings(
  ...
  return apiFetch<WorkerSettings>(
    `/workers/${encodeURIComponent(name)}/settings`,
    {},
    options,
  );
}
...
export async function getWorkerSchedules(
  ...
  return apiFetch<{ schedules: WorkerSchedule[] }>(
    `/workers/${encodeURIComponent(name)}/schedules`,
    {},
    options,
  );
}
...
export async function getWorkerSubdomain(
  ...
  return apiFetch<SubdomainStatus>(
    `/workers/${encodeURIComponent(name)}/subdomain`,
    {},
    options,
  );
}
...
export async function getAccountSubdomain(
  options?: FetchOptions,
): Promise<ApiResponse<AccountSubdomain>> {
...
export async function listPages(
  options?: FetchOptions,
): Promise<ApiResponse<PagesProject[]>> {
...
export async function getPageDeployments(
  ...
  return apiFetch<PagesDeployment[]>(
    `/pages/${encodeURIComponent(name)}/deployments`,
    {},
    options,
  );
}
...
export async function getPageDomains(
  ...
  return apiFetch<PagesDomain[]>(
    `/pages/${encodeURIComponent(name)}/domains`,
    {},
    options,
  );
}
...
export async function addPageDomain(
  ...
  return apiFetch<PagesDomain>(
    `/pages/${encodeURIComponent(projectName)}/domains`,
    {
      method: "POST",
...
export async function deletePageDomain(
  ...
  invalidateCache(`/pages/${projectName}/domains`);
  return apiFetch<null>(
    `/pages/${encodeURIComponent(projectName)}/domains/${encodeURIComponent(domainName)}`,
    {
      method: "DELETE",
    },
  );
...
export async function rollbackPageDeployment(
  ...
  return apiFetch<PagesDeployment>(
    `/pages/${encodeURIComponent(projectName)}/rollback`,
    {
      method: "POST",
