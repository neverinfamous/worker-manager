...
export function PageDetailView({
  ...
  onBack,
  onRefresh,
}: PageDetailViewProps): React.ReactNode {
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-lg flex items-center gap-2">
              <Badge
                variant={
                  latestDeploy?.latest_stage?.status === "success"
                    ? "success"
                    : "secondary"
                }
              >
                    ...
                    >
                        ...
                        <Badge
                          variant={
                            deploy.latest_stage?.status === "success"
                              ? "success"
                              : deploy.latest_stage?.status === "failure"
                                ? "destructive"
                                : "secondary"
                          }
                        >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {deploy.environment === "production" &&
                          deploy.id !== latestDeploy?.id && (
                            <Button
                              variant="outline"
                              size="sm"
                              disabled={rollingBack === deploy.id}
                              onClick={() => {
                                void handleRollback(deploy.id);
                              }}
                            >
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Custom domains pointing to this project
                </CardDescription>
              </div>
              <Button
                size="sm"
                  ...
                  {domains.map((domain) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Badge
                          variant={
                            domain.status === "active" ? "success" : "secondary"
                          }
                        >
                          {domain.status}
                        </Badge>
                        <Button
                          ...
                          onClick={() => {
                            void handleDeleteDomain(domain.name);
                          }}
                        >
                          <Trash2 className="h-4 w-4" />
                        </Button>
