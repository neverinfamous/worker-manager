        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a route for <code className="bg-muted px-1 rounded">{workerName}</code>
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="pattern"
                            placeholder={selectedZoneName ? `${selectedZoneName}/*` : 'example.com/*'}
                            value={pattern}
                        ...
                        <div className="text-xs text-muted-foreground space-y-1">
                            <p>Use <code>*</code> as a wildcard. Examples:</p>
                            <ul className="list-disc list-inside ml-2">
                                <li><code>example.com/*</code> - All paths</li>
                                <li><code>example.com/api/*</code> - API paths only</li>
